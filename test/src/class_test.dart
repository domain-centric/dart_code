...
void main() {
  group('Class class', () {
    ...
    test("Should return: abstract class", () {
      ...
      ).toString().should.be('abstract class Person {}');
    });
    ...
    test("Should return: abstract class", () {
      ...
      ).toString().should.be('abstract interface class Person {}');
    });

    test("Should return: class with super class", () {
      Class(
        'Person',
        superClass: Type('Contact', libraryUri: 'package:my_lib/contact.dart'),
      ).toString().should.be('class Person extends i1.Contact {}');
    });
    ...
    test("Should return: class with getter method", () {
      Class(
        ...
        'class Person {set age(int age) {this.age = age;}}',
      );
    });
  ...
  group("Person class", () {
    test('Person.fullName property', () {
      ...
      Person(
        ...
        'ten Hoeve',
        dateOfBirth,
      ).fullName.should.be('Nils ten Hoeve');
    });

    test('Person.ageInYears property', () {
      var ageInYears = 30;
      var dateOfBirth = DateTime.now().subtract(
        Duration(days: 366 * ageInYears),
      );
    ...
    test('Person.greetingMessage() method', () {
      ...
      Person(
        ...
        'ten Hoeve',
        dateOfBirth,
      ).greetingMessage().should.be("Hello Nils ten Hoeve.");
    });
  });
}
