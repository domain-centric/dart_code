...
void main() {
    ...
    group('Comment.fromString() constructor', () {
      ...
      test(
        ...
        () {
          ...
          Comment.fromString(
            longLineComment,
          ).toString().should.be('// ' + longLineComment + '\n');
        },
      );
      ...
      test(
        ...
        () {
          ...
          Comment.fromString(
            commentWithLeadingSlashes,
          ).toString().should.be('// ' + commentText + '\n');
        },
      );
  ...
  group('DocComment class', () {
    ...
    group('Comment.fromList() constructor', () {
      test("Should return: 2x'/// Single line comment\n'", () {
        var comment = 'Single line comment';
        DocComment.fromList([comment, comment]).toString().should.be(
          '/// ' + comment + '\n' + '/// ' + comment + '\n',
        );
      });
