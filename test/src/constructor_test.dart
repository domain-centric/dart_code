...
main() {
  group('ConstructorCall class', () {
    ...
    test("Should return: super.origin()", () {
      ConstructorCall(name: 'origin', super$: true)
          .toString()
          .should
          .be('super.origin()');
    });
  ...
  group('Initializers class', () {
    ...
    test("gender = Gender.male, age = 30, super(name = 'Nils')", () {
      Initializers(
          ...
          .toString()
          .should
          .be('gender = Gender.male,age = 30,super(name: \'Nils\')');
    });
  });
  ...
  group('Constructor class', () {
    ...
    test("Should return: Constructor with doc comment and annotation", () {
      Constructor(Type('Person'), docComments: [
        DocComment.fromString(
            'A Person that can be converted to and from Json format')
      ], annotations: [
        Annotation(Type('JsonSerializable',
    ...
    test("Should return: external Person();", () {
      Constructor(Type('Person'), external: true)
          .toString()
          .should
          .be('external Person();');
    });
    ...
    test("Should return: const Person();\n", () {
      Constructor(Type('Person'), constant: true)
          .toString()
          .should
          .be('const Person();');
    });
    ...
    test("Should return: factory Person();\n", () {
      Constructor(Type('Person'), factory: true)
          .toString()
          .should
          .be('factory Person();');
    });
    ...
    test("Should return: factory Point.origin();\n", () {
      Constructor(Type('Point'), name: 'origin', factory: true)
          .toString()
          .should
          .be('factory Point.origin();');
    });
      ...
      Constructor(Type('Person'),
              initializers: Initializers(
                  fieldInitializers: [
                    ...
                    FieldInitializer(
                        familyName, Expression.ofString('ten Hoeve')),
                  ],
                  constructorCall: ConstructorCall(
                      parameterValues: ParameterValues([
          ...
          .toString()
          .should
          .be('Person() : givenName = \'Nils\',familyName = \'ten Hoeve\',this(gender: Gender.male,age: 30) {this.fullName = _appendNames(givenName,familyName);};');
    });
  });
}
