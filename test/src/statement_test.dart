...
main() {
    ...
    group('Statement.assert() constructor', () {
      ...
      test("Should return: 'assert(b == false, 'b must be false');\n'", () {
        Statement.assert$(
            ...
            .toString()
            .should
            .be('assert(b == false,\'b must be false\');');
      });
    });

    group('Statement.assignVariable() constructor', () {
      test("Should return: greeting = 'Hello World';\n", () {
        Statement.assignVariable("greeting", Expression.ofString('Hello World'))
            .toString()
            .should
      ...
      test("Should return: for loop statements'", () {
        Statement
                .for$(
                    ...
                    Expression.ofVariable('i')
                        .greaterOrEqualTo(Expression.ofInt(0)),
                    Expression.ofVariable('i').increment(),
                    Block([Statement.print(Expression.ofVariable('i'))]))
            .toString()
            .should
            .be('for (int i = 10; i >= 0; i++) {print(i);};');
      });
    });
    ...
    group('Statement.if\$() constructor', () {
      ...
      test("Should return if statement with else statement", () {
        Statement.if$(Expression.ofBool(true),
            ...
            .toString()
            .should
            .be('if (true){print(\'True\');} else {print(\'False\');}');
      });
    });
      ...
      test("Should return if chain statement with else statement", () {
        Statement.ifChain$({
          ...
          Expression.ofVariable(number).equalTo(Expression.ofInt(2)):
            ...
            .toString()
            .should
            .be('if (number == 1) {print(\'One\');} else if (number == 2) {print(\'Two\');} else {print(\'Other\');};');
      });
    });
  });
  ...
  group('Statement.return\$ constructor', () {
    test("Should return: 'test();\n'", () {
      Statement.return$(Expression.ofString('Hello World'))
          .toString()
          .should
          .be('return \'Hello World\';');
    });
  });
  ...
  group('Statement.throw\$() constructor', () {
    test("Should return: throw 'Out of camels!';\n", () {
      Statement.throw$(Expression.ofString('Out of camels!'))
          .toString()
          .should
          .be('throw \'Out of camels!\';');
    });

    test("Should return: throw OutOfCamelException();\n", () {
      Statement.throw$(Expression.callConstructor(Type('OutOfCamelException')))
          .toString()
          .should
          .be('throw OutOfCamelException();');
    });
  });
  ...
  group('Statement.try\$() constructor', () {
    ...
    test("Should return: try statement with finally", () {
      Statement.try$(
          ...
          .toString()
          .should
          .be('try {breedMoreCamels();} finally {cleanCamelStalls();};');
    });
  });
  ...
  group('Statement.switch\$() constructor', () {
    ...
    test("Should return: switch statement with else statement", () {
      Statement.switch$(
          ...
          .toString()
          .should
          .be('switch (number) {case 1: {print(\'One\');break;}case 2: {print(\'Two\');break;}default: {print(\'Other\');}};');
    });
  });
  ...
  group('Statement.while\$ constructor', () {
    test("Should return while loop statement ", () {
      ...
      Statement.while$(
          ...
          .toString()
          .should
          .be('while (counter < 5) {print(counter);counter++};');
    });
  });
    ...
    test("Should return while loop statement ", () {
      ...
      Statement.doWhile$(
        ...
        Expression.ofVariable(counter).lessThan(Expression.ofInt(5)),
          ...
          .toString()
          .should
          .be('do {print(counter);counter++} while (counter < 5);');
    });
  });
